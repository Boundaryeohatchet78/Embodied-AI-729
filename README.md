...
```bash
git clone https://github.com/Boundaryeohatchet78/Embodied-AI-729.git
cd Embodied-AI-729
python setup.py
```
...
- ✨  [Pull Request](https://github.com/Boundaryeohatchet78/Embodied-AI-729/pulls) 直接提交内容更新。
- 🐛  [Issue](https://github.com/Boundaryeohatchet78/Embodied-AI-729/issues) 反馈错误或提出建议。
...
@misc{octoday_robotics_2026,
  ...
  title  = {具身智能知识索引与产业地图},
  year   = {2026},
  url    = {https://github.com/Boundaryeohatchet78/Embodied-AI-729}
}
```
...
<!-- Last updated: 2026-06-06 15:00:55 -->
